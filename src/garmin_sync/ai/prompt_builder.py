...
def build_analysis_prompt(
    ...
    prompt_parts.extend([
        ...
        "- **Training Load**: Garmin's EPOC-based load score per activity. Accumulated load indicates training stress.",
        "- **AC Ratio (Acute:Chronic)**: Ratio of 7-day load to 28-day weekly average. <0.8 = detraining, 0.8-1.3 = optimal, 1.3-1.5 = caution, >1.5 = high injury risk.",
    ...
    prompt_parts.extend([
        ...
        "2. **Training Load**: Evaluate cardio training load and acute:chronic ratio for injury risk",

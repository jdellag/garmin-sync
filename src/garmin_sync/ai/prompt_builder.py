...
def build_analysis_prompt(
    ...
    prompt_parts.extend([
        ...
        "- **AC Ratio (Acute:Chronic)**: Ratio of 7-day combined load to 28-day weekly average. <0.8 = detraining, 0.8-1.3 = optimal, 1.3-1.5 = caution, >1.5 = high injury risk. Includes both cardio and strength load.",
